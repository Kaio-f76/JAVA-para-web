...
public class LoginUsuarioSrv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Verifica se o usuário já está logado (session)
            ...
            switch (acao) {
                ...
                case "telaLogin":
                    ...
                    session = request.getSession(); // Cria uma nova sessão ou usa a existente
                    session.setAttribute("usuarioLogado", usuarioEncontrado);

                    System.out.println("\n" + "Usuario autorizado!" + "\n");

                    response.sendRedirect("tabelaDadosUsuarioSrv?acao=telaResultados"); //corrige o erro do "reenviarDados"
